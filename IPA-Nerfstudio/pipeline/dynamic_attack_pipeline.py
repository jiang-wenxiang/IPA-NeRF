...
from datamanager.attack_datamanager import AttackVanillaDataManagerConfig, AttackVanillaDataManager
from pipeline.attack_pipeline import AttackVanillaPipelineConfig, AttackVanillaPipeline


@dataclass
class AttackDynamicBatchPipelineConfig(AttackVanillaPipelineConfig):
    """Dynamic Batch Pipeline Config"""

    _target: Type = field(default_factory=lambda: AttackDynamicBatchPipeline)
...
class AttackDynamicBatchPipeline(AttackVanillaPipeline):
    """Pipeline with logic for changing the number of rays per batch."""

    config: AttackDynamicBatchPipelineConfig
    ...
    def __init__(
        ...
        # assert isinstance(
        #     self.datamanager, AttackVanillaDataManager
