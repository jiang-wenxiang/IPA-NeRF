...
def entrypoint():
    ...
    data_path = Path("./data/mip_nerf_360/bonsai")
    attack_flag = True
    device = 0
    ...
    # config.pipeline.datamanager.eval_num_images_to_sample_from = 40
    # config.pipeline.datamanager.eval_num_times_to_repeat_images = 100
    config.epsilon = 32.0

    # config.load_dir = Path("./outputs/unnamed/nerfacto/2024-04-21_115609/nerfstudio_models")
