...
from datamanager.attack_datamanager import AttackVanillaDataManager, AttackVanillaDataManagerConfig

from nerfstudio.data.dataparsers.blender_dataparser import BlenderDataParserConfig
from nerfstudio.data.dataparsers.dnerf_dataparser import DNeRFDataParserConfig
from nerfstudio.data.dataparsers.instant_ngp_dataparser import InstantNGPDataParserConfig
from dataparser.attack_dataparser import AttackNerfstudioDataParserConfig
...
from pipeline.dynamic_attack_pipeline import AttackDynamicBatchPipelineConfig
from trainer.attack_trainer import AttackTrainerConfig
...
from pipeline.attack_pipeline import AttackVanillaPipelineConfig
from nerfstudio.pipelines.dynamic_batch import DynamicBatchPipelineConfig
from nerfstudio.plugins.registry import discover_methods

method_configs: Dict[str, AttackTrainerConfig] = {}
descriptions = {
...
method_configs["nerfacto"] = AttackTrainerConfig(
    method_name="nerfacto",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(
            dataparser=AttackNerfstudioDataParserConfig(),
...
method_configs["nerfacto-big"] = AttackTrainerConfig(
    method_name="nerfacto",
    steps_per_eval_batch=500,
    steps_per_save=2000,
...
method_configs["nerfacto-huge"] = AttackTrainerConfig(
    method_name="nerfacto",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=100000,
...
method_configs["depth-nerfacto"] = AttackTrainerConfig(
    ...
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(
            _target=AttackVanillaDataManager[DepthDataset],
            dataparser=AttackNerfstudioDataParserConfig(),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
            camera_optimizer=CameraOptimizerConfig(
...
method_configs["volinga"] = AttackTrainerConfig(
    method_name="volinga",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
...
method_configs["instant-ngp"] = AttackTrainerConfig(
    method_name="instant-ngp",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
    pipeline=AttackDynamicBatchPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(
            dataparser=AttackNerfstudioDataParserConfig(),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
...
method_configs["instant-ngp-bounded"] = AttackTrainerConfig(
    ...
    mixed_precision=True,
    pipeline=AttackDynamicBatchPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(dataparser=InstantNGPDataParserConfig(), train_num_rays_per_batch=8192),
...
method_configs["mipnerf"] = AttackTrainerConfig(
    method_name="mipnerf",
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(dataparser=AttackNerfstudioDataParserConfig(), train_num_rays_per_batch=1024),
...
method_configs["semantic-nerfw"] = AttackTrainerConfig(
    ...
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(
            _target=AttackVanillaDataManager[SemanticDataset],
...
method_configs["vanilla-nerf"] = AttackTrainerConfig(
...
method_configs["tensorf"] = AttackTrainerConfig(
    method_name="tensorf",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
...
method_configs["dnerf"] = AttackTrainerConfig(
    method_name="dnerf",
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(dataparser=DNeRFDataParserConfig()),
        model=VanillaModelConfig(
            _target=NeRFModel,
...
method_configs["phototourism"] = AttackTrainerConfig(
...
method_configs["generfacto"] = AttackTrainerConfig(
...
method_configs["neus"] = AttackTrainerConfig(
    method_name="neus",
    ...
    pipeline=AttackVanillaPipelineConfig(
        datamanager=AttackVanillaDataManagerConfig(
            _target=AttackVanillaDataManager[SDFDataset],
...
method_configs["neus-facto"] = AttackTrainerConfig(
